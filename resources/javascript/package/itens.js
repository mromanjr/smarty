...
var oItens = {
    ...
    setPrincipal: function(codfotoNew) {
        ...
        $('#foto-cores-'+codfotoNew).css("border","1px solid #8B4774");
    ...
    addCart: function(tam) {
        if (unescape(tam) != "undefined"){
            if (confirm("O Modelo/Tamanho selecionado é: " + unescape(tam) + "\n\nColocar no carrinho?"))
